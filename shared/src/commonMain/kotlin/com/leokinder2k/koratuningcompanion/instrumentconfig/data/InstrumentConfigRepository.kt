...
class DataStoreInstrumentConfigRepository(
    private val dataStore: DataStore<Preferences> = createInstrumentConfigDataStore()
    ...
    companion object {
        ...
        private fun parseCentsList(serialized: String?, stringCount: Int): List<Double> {
            ...
            if (serialized.isNullOrBlank()) return fallback
        ...
        private fun parseUserPresetRecord(record: String): UserPreset? {
            ...
            if (stringCount !in SUPPORTED_STRING_COUNTS) return null
            ...
            if (openPitches.size != stringCount) return null
        ...
        private fun buildPresetId(): String {
            return "user_${currentTimeMillis()}_${Random.nextInt(1000, 9999)}"
        }
