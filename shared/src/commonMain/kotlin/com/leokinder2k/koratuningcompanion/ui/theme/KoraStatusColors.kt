...
val KoraLeverClosedStringColor = Color(0xFFFF8C00)  // amber  — close lever only
val KoraDetunedColor = Color(0xFF6EC6FF)            // blue   — peg retune only
val KoraCombinedChangesColor = Color(0xFF9C27B0)    // purple — both lever closed AND peg retune
